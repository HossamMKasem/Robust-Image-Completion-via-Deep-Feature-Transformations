...
local targets = torch.zeros(trainer.batch_size, 3,
 ...
 --local targets = torch.zeros(trainer.batch_size, 1,
  ...
  mean_Time=torch.zeros(20):float()
  mean_MSE_error_Train=torch.zeros(20):float()
  mean_Time[epoch]= time*1000
  mean_MSE_error_Train[epoch]=epoch_error/nbr_samples
  torch.save('/data/hossamkasem/3-DFTN_Exper._CVPR_TNNL/6-Missing_Parts_Exp/R/1-one_angle/DFT(ours)/MSE/Time_Train/mean_MSE_error_Train'..epoch..'.bin',mean_Time)
  torch.save('/data/hossamkasem/3-DFTN_Exper._CVPR_TNNL/6-Missing_Parts_Exp/R/1-one_angle/DFT(ours)/MSE/MSE_Train/mean_MSE_error_Train'..epoch..'.bin',epoch_error/nbr_samples)
  torch.save('/data/hossamkasem/3-DFTN_Exper._CVPR_TNNL/6-Missing_Parts_Exp/R/1-one_angle/DFT(ours)/MSE/MSE_Train/mean_MSE_error_Train_total.bin',mean_MSE_error_Train)
...
if  epoch==10 then 
  ...
  mean_MSE_error_Test=torch.zeros(20):float()
  mean_Time_Test=torch.zeros(20):float()
  mean_Time_Test[epoch]=time*1000
  mean_MSE_error_Test[epoch]=epoch_error/nbr_samples
  torch.save('/data/hossamkasem/3-DFTN_Exper._CVPR_TNNL/6-Missing_Parts_Exp/R/1-one_angle/DFT(ours)/MSE/Time_Test/mean_Time_Test'..epoch..'.bin',mean_Time_Test)
  torch.save('/data/hossamkasem/3-DFTN_Exper._CVPR_TNNL/6-Missing_Parts_Exp/R/1-one_angle/DFT(ours)/MSE/MSE_Test/mean_MSE_error_Test'..epoch..'.bin',epoch_error/nbr_samples)
  torch.save('/data/hossamkasem/3-DFTN_Exper._CVPR_TNNL/6-Missing_Parts_Exp/R/1-one_angle/DFT(ours)/MSE/MSE_Test/mean_MSE_error_Test_total.bin',mean_MSE_error_Test)
